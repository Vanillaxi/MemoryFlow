...
func (a *MemoryAgent) newAskMemoryEinoTool() tool.BaseTool {
...
func (a *MemoryAgent) newSearchMemoryEinoTool() tool.BaseTool {
	return &EinoMemoryTool{
...
func (a *MemoryAgent) newListRecentEinoTool() tool.BaseTool {
	return &EinoMemoryTool{
		name: ToolListRecent,
...
func (a *MemoryAgent) newGetTimelineEinoTool() tool.BaseTool {
	return &EinoMemoryTool{
