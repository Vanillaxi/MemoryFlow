...
func NewArkEinoChatModel(baseURL, apiKey, modelName string) *ArkEinoChatModel {
	return NewArkEinoChatModelWithConfig(Config{
		BaseURL:   baseURL,
		APIKey:    apiKey,
		ModelName: modelName,
	})
...
func NewArkEinoChatModelWithConfig(cfg Config) *ArkEinoChatModel {
	client := &http.Client{}
